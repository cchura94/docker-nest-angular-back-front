...
export class UsersRolesPermissions1749693993970 implements MigrationInterface {
    name = 'UsersRolesPermissions1749693993970'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "permission" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying NOT NULL, "descripcion" character varying, "action" character varying, "subject" character varying, CONSTRAINT "UQ_692a194723f4705a9e1ee81dee4" UNIQUE ("nombre"), CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`);
